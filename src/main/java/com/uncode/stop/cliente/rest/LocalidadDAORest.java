...
public class LocalidadDAORest {
	...
	public void crear(LocalidadDTO localidad) {
		String uri = "http://200.45.208.176:9000/localidades";
	...
	public void modificar(LocalidadDTO localidad) {
		...
		String uri = "http://200.45.208.176:9000/localidades/" + localidad.getId();
	...
	public void eliminar(UUID id) {
		...
		String uri = "http://200.45.208.176:9000/localidades/" + id;
	...
	public List<LocalidadDTO> listarLocalidadesPorDepartamento(UUID localidadesId) {
	    String uri = "http://200.45.208.176:9000/localidades/listarLocalidadesPorDepartamento/" + localidadesId;
