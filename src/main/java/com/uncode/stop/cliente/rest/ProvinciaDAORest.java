...
public class ProvinciaDAORest {
	...
	public void crear(ProvinciaDTO provincia) {
		...
		String uri = "http://200.45.208.176:9000/provincias";
	...
	public void modificar(ProvinciaDTO provincia) {
		...
		String uri = "http://200.45.208.176:9000/provincias/" + provincia.getId();
	...
	public void eliminar(UUID id) {
		...
		String uri = "http://200.45.208.176:9000/provincias/" + id;
	...
	public List<ProvinciaDTO> listarProvinciasPorPais(UUID paisId) {
	    String uri = "http://200.45.208.176:9000/provincias/listarProvinciasPorPais/" + paisId;
